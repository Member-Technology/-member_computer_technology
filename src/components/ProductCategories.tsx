...
const categories = [
  { id: 'laptop', name: 'Laptops', count: '150+', trend: '+12%', icon: Laptop, color: 'from-blue-400 to-blue-600' },
  { id: 'desktop', name: 'Desktops', count: '80+', trend: '+8%', icon: Monitor, color: 'from-green-400 to-green-600' },
  { id: 'gaming', name: 'Gaming PCs', count: '45+', trend: '+25%', icon: Gamepad2, color: 'from-purple-400 to-purple-600' },
  { id: 'accessories', name: 'Accessories', count: '200+', trend: '+15%', icon: Smartphone, color: 'from-orange-400 to-orange-600' },
];
        ...
        >
          <div className="bg-slate-800/50 backdrop-blur-xl border border-slate-700/50 rounded-3xl p-8 max-w-2xl mx-auto mb-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-slate-300">
              ...
              <div className="font-medium">ERAZER MEDION</div>
              <div className="font-medium">GIGABYTE</div>
              <div className="font-medium">OMEN GEFORCE</div>
